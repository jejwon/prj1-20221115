...
public class BoardController {
	...
	public String register(BoardDto board, MultipartFile[] files, RedirectAttributes rttr) { // session ok, query string
																								// ok
		// * 파일업로드
		// 1. web.xml
...
//		}
	...
	public String modify(BoardDto board, @RequestParam("files") MultipartFile[] addFiles,
			@RequestParam(name = "removeFiles", required = false) List<String> removeFiles, RedirectAttributes rttr) {
//		// 지울 파일명 들어오는 지 확인
