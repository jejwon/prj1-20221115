		...
		<div class="row">
			<div class="col">
				...
				<form id="form1" action="" method="post">
					...
					<div class="mb-3">
						<label for="" class="form-label"> 아이디 </label> <input
							class="form-control-plaintext" type="text" value="${member.id }"
							readonly>
					</div>
					<div class="mb-3">
					...
					<div class="mb-3">
						...
						<div class="input-group">
							<input id="emailInput1" class="form-control" type="email"
								...
								data-old-value="${member.email }">
							<button disabled id="emailButton1" type="button"
								class="btn btn-outline-secondary">중복확인</button>
						</div>
						<div id="emailText1" class="form-text"></div>
					</div>
					<div class="mb-3">
						<label for="" class="form-label"> 가입일시 </label> <input
							class="form-control-plaintext" type="text"
							value="${member.inserted }" readonly>
					</div>
				...
				<input disabled id="modifyModalButton1" class="btn btn-warning"
					type="submit" value="수정" data-bs-toggle="modal"
					data-bs-target="#modifyModal"> <input
					class="btn btn-danger" type="submit" value="탈퇴"
